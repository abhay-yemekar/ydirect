...
3. **Portability:** content is difficult to back up or move between tools.
4. **Sharing:** sending an entire document or library exposes more than a collaborator needs.
...
Approved replies, escalation instructions, troubleshooting steps, and safe diagnostic requests.

### Sales and recruiting

Outreach variants, follow-ups, qualification questions, scheduling messages, and role summaries.

### Founders and operations

Product descriptions, launch notes, status updates, routine partner messages, and recurring instructions.
...
Prompts, captions, citations, research notes, frequently used links, and repeated formatting blocks.

## Jobs to be done

- When I am writing on the web, help me retrieve approved text without leaving the page.
- When my library grows, help me find the right item quickly.
- When I switch accounts, keep local data separated.
